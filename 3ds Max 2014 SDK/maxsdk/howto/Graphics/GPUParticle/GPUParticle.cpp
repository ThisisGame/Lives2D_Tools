...
class ParticleRenderer : public MaxSDK::Graphics::ICustomRenderItem
{
	...
	VertexBufferHandleArray mStreamOutBuffers;
...
public:
	ParticleRenderer()
	{
		...
		*/
		...
		mQuad.Initialize(sizeof(Point2));
		mQuad.SetBufferUsageType(BufferUsageStatic);
		mQuad.SetNumberOfVertices(4);
		...
		mQuadIdx.Initialize(IndexTypeShort);
		mQuadIdx.SetNumberOfIndices(6);
...
bool GPUParticle::PrepareDisplay(const MaxSDK::Graphics::MaxContext& maxContext, 
