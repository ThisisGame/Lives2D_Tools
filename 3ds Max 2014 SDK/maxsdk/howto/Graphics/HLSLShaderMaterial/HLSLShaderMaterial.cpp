...
RefResult HLSLShaderMaterial::NotifyRefChanged(Interval changeInt, RefTargetHandle hTarget, 
...
void HLSLShaderMaterial::CreateHLSLMaterialHandle(MaxSDK::Graphics::GraphicFeatureLevel featureLevel)
{
	...
	{
		TSTR hlslShaderDX9 = pRootDir + TSTR(_T("hardwareshaders\\SimpleColor.fx"));
		HLSLMaterialHandle hlslMaterialHandleDX9;
		hlslMaterialHandleDX9.InitializeWithFile(MSTR(hlslShaderDX9.data()));
		m_HLSLDX9MaterialHandle = hlslMaterialHandleDX9;
	}
	else
	{
		TSTR hlslShaderDX11 = pRootDir + TSTR(_T("hardwareshaders\\SimpleColor11.fx"));
		HLSLMaterialHandle hlslMaterialHandleDX11;
		hlslMaterialHandleDX11.InitializeWithFile(MSTR(hlslShaderDX11.data()));
