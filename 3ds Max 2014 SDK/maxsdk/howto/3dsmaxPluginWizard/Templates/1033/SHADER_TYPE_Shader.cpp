...
public:
	...
	void NotifyChanged() { NotifyDependents(FOREVER, (PartID)PART_ALL, REFMSG_CHANGE); }
...
RefResult [!output CLASS_NAME]::NotifyRefChanged(Interval /*changeInt*/, RefTargetHandle hTarget, PartID& /*partID*/, RefMessage message )
{
	switch (message) {
	case REFMSG_CHANGE:
		ivalid.SetEmpty();
